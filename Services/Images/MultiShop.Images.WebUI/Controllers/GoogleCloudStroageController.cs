...
using MultiShop.Images.WebUI.DAL.Entites;
using MultiShop.Images.WebUI.Services;

namespace MultiShop.Images.WebUI.Controllers
{
    public class GoogleCloudStroageController : Controller
    {

      
        private readonly ICloudStorageService _cloudStorageService;

        public GoogleCloudStroageController(ICloudStorageService cloudStorageService)
        {
