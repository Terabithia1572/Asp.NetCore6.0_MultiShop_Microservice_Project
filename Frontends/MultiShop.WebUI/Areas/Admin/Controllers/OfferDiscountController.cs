...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class OfferDiscountController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //}
            //return View();
            OfferDiscountViewBags(); // ViewBag'ler ayarlanır.
            var values = await _offerDiscountService.GetAllOfferDiscountAsync(); // Tüm İndirim Teklif verileri alınır.
            return View(values); // View'e gönderilir.
        }
        [HttpGet]
        ...
        public async Task<IActionResult> DeleteOfferDiscount(string id)
        {
            ...
            //}
            //return View(); // Başarısız ise aynı view döndürülür.
            await _offerDiscountService.DeleteOfferDiscountAsync(id); // İndirim Teklif silme işlemi yapılır.
            return RedirectToAction("Index", "OfferDiscount", new { area = "Admin" }); // İndirim Teklif listesine yönlendirilir.
        }
        [HttpGet("{id}")]
        public async Task<IActionResult> UpdateOfferDiscount(string id)
        {
            ...
            //return View(); // Başarısız ise aynı view döndürülür.
            OfferDiscountViewBags(); // ViewBag'ler ayarlanır.
            var values = await _offerDiscountService.GetByIDOfferDiscountAsync(id); // ID'ye göre İndirim Teklif verisi alınır.
            return View(values);
        }
        [HttpPost("{id}")]
        public async Task<IActionResult> UpdateOfferDiscount(UpdateOfferDiscountDTO updateOfferDiscountDTO)
        {
            ...
            //}
            //return View(); // Başarısız ise aynı view döndürülür.
            await _offerDiscountService.UpdateOfferDiscountAsync(updateOfferDiscountDTO); // İndirim Teklif güncelleme işlemi yapılır.
            return RedirectToAction("Index", "OfferDiscount", new { area = "Admin" }); // İndirim Teklif listesine yönlendirilir.
        }
        void OfferDiscountViewBags()
        {
            ViewBag.v1 = "Ana Sayfa";
            ViewBag.v2 = "İndirim Teklifler";
            ViewBag.v3 = "İndirim Teklif Listesi";
